...
@Component({
  selector: 'app-diapo81',
  templateUrl: './diapo81.component.html',
  styleUrls: ['./diapo81.component.scss']
})

export class Diapo81Component implements OnInit {
    ...
    pregunta = {
        id: '65',
        question: 'No esgotar el total el total dels diners rebuts en una subvenció i retornar-los.',
        answers: [
        ...
        corrects: ['b'],
        feedback: [
            'Es una conducta ètica i responsable. '
        ]
    }
