...
@Component({
  selector: 'app-diapo66',
  templateUrl: './diapo66.component.html',
  styleUrls: ['./diapo66.component.scss']
})

export class Diapo66Component implements OnInit {
    ...
    pregunta = {
        id: '52',
        question: 'Contractar el servei de transport d’usuaris o de matèries primeres o producte acabat a l’empresa mes econòmica sabent que la flota de vehicles és antiga i mes contaminant.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'Òbviament no es cap delicte. Generalment l’ètica s’ha definit com el “Conjunt de principis i regles que regulen el comportament i les relacions humanes”. L’estudi ètic de les relacions entre les persones i el medi ambient a sorgit  fa molt poc i ha estat en la base constructiva de protocols com el de Kioto.',
            'En base a aquesta nova ètica podríem afirmar que la contractació d’un proveïdor mes contaminat (en el supòsit de saber-ho) seria èticament reprotxable.'
        ]
    }
