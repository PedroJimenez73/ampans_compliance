...
@Component({
  selector: 'app-diapo80',
  templateUrl: './diapo80.component.html',
  styleUrls: ['./diapo80.component.scss']
})

export class Diapo80Component implements OnInit {
    ...
    pregunta = {
        id: '64',
        question: 'Presentar-se a una convocatòria de subvenció incrementant els conceptes a subvencionar.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'Podria considerar-se un delicte contra la hisenda publica. Presumiblement hem d’entendre que si s’incrementen els conceptes en cas de justificació també s’alteraran aquests.'
        ]
    }
