...
@Component({
  selector: 'app-diapo73',
  templateUrl: './diapo73.component.html',
  styleUrls: ['./diapo73.component.scss']
})

export class Diapo73Component implements OnInit {
    ...
    pregunta = {
        id: '58',
        question: 'En el moment de formalitzar una pretutela dir al sol·licitant que cal que faci testament dels seus bens a favor de l’Entitat Tutelar.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'Estaríem davant un possible delicte d’estafa dons es pretén actuar sobre les propietats de la persones en base un engany.'
        ]
    }
