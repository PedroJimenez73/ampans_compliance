...
@Component({
  selector: 'app-diapo76',
  templateUrl: './diapo76.component.html',
  styleUrls: ['./diapo76.component.scss']
})

export class Diapo76Component implements OnInit {
    ...
    pregunta = {
        id: '61',
        question: 'Una empresa diu que elabora un producte  si en realitat l’elabora  un aliat estratègic seu.',
        answers: [
