...
@Component({
  selector: 'app-diapo40',
  templateUrl: './diapo40.component.html',
  styleUrls: ['./diapo40.component.scss']
})

export class Diapo40Component implements OnInit {
    ...
    pregunta = {
        id: '30',
        question: 'Supervisar el telèfon d’una persona davant la sospita d’una activitat social perillosa.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'Es una vulneració del dret a la privacitat de la persona. Com a mínim tindríem que tenir l’autorització d’una autoritat judicial o almenys del tutor i haver informat a la persona que es supervisarà el telf.'
        ]
    }
