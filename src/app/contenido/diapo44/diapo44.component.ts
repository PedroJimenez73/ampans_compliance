...
@Component({
  selector: 'app-diapo44',
  templateUrl: './diapo44.component.html',
  styleUrls: ['./diapo44.component.scss']
})

export class Diapo44Component implements OnInit {
    ...
    pregunta = {
        id: '33',
        question: 'Esborrar una intervencions a Entigest que es erronea.',
        answers: [
        ...
        corrects: ['b'],
        feedback: [
            'No podem deixar dades errònies. Com a mínim ho tindríem que indicar o esborrar. Es d’agrair que els programes guardin registre de totes les modificacions eliminacions que es puguin fer. En el cas d’Entigest solament ho fa amb les dades mediques. La conducta es correcte.'
        ]
    }
