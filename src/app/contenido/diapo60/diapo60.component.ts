...
export class Diapo60Component implements OnInit {
    ...
    pregunta = {
        id: '47',
        question: 'El responsable de compres selecciona  un proveïdor perquè és familiar seu',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'En aquest comportament hi ha un clar conflicte d’interessos. La conducta es reprovable.'
        ]
    }
