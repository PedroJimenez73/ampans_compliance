...
export class Diapo41Component implements OnInit {
    ...
    pregunta = {
        id: '31',
        question: 'Instal·lar i utilitzar en el mòbil d’una persona amb discapacitat apps de geolocalització i seguiment amb autorització del tutor.',
        answers: [
        ...
        corrects: ['b'],
        feedback: [
            'Vulnera el dret a la privacitat, però en aquest cas amb autorització del tutor. Caldria informar a la persona que porta un sistema de localització per a la seva protecció. Entemen que es correcte.'
        ]
    }
