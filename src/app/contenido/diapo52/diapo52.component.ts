...
export class Diapo52Component implements OnInit {
    ...
    pregunta = {
        id: '40',
        question: 'Explicar a un grup d’entitats de Galicia el funcionament d’una  plataforma d’intercanvi  d’indicadors  de la qual en fem la gestió per encàrrec de l’entitat titular.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'La plataforma de indicadors no es nostra i no podem explicar-la sense autorització de l’entitat que ens ha encarregat la gestió.'
        ]
    }
