...
@Component({
  selector: 'app-diapo53',
  templateUrl: './diapo53.component.html',
  styleUrls: ['./diapo53.component.scss']
})

export class Diapo53Component implements OnInit {
    ...
    pregunta = {
        ...
        corrects: ['a'],
        feedback: [
            'L’organització i els mètodes de treball formen part del coneixement de l’empresa. Nosaltres hi tenim accés dons hi treballem fent un feina subcontractada. No es adequat revelar aquest coneixement a altres persones sense autorització.'
        ]
    }
