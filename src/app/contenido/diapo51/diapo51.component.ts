...
export class Diapo51Component implements OnInit {
    ...
    pregunta = {
        id: '39',
        question: 'Expliquem en unes jornades el nostre proces d’elaboració d’un dels tipus de formatges de cabra que fem a la formatgeria.',
        answers: [
        ...
        corrects: ['b'],
        feedback: [
            'Si nosaltres som els propietaris i coneixedor del proces d’elaboració i el revelem de manera voluntària no hi ha cap problema. Seria molt diferent que ho fes una persona a títol personal sense autorització d’AMPANS. En el primer cas no hi hauria cap problema.'
        ]
    }
