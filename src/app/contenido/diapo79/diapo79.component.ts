...
@Component({
  selector: 'app-diapo79',
  templateUrl: './diapo79.component.html',
  styleUrls: ['./diapo79.component.scss']
})

export class Diapo79Component implements OnInit {
    ...
    pregunta = {
        id: '63',
        question: 'Aplicar les bonificacions previstes per la seguretat social en la contractació de persones amb discapacitat.',
        answers: [
