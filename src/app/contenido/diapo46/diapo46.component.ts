...
@Component({
  selector: 'app-diapo46',
  templateUrl: './diapo46.component.html',
  styleUrls: ['./diapo46.component.scss']
})

export class Diapo46Component implements OnInit {
    ...
    pregunta = {
        id: '35',
        question: 'Esborrar algunes fotografies del telèfon  d’una persona amb discapacitat per ser inadequades.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'Malgrat les esborrem amb la finalitat de protegir a la persona estem infringit una violació de la intimitat i eliminat unes dades que no son nostres. Ens caldrien autoritzacions. La conducta que es planteja la pregunta no es correcte.'
        ]
    }
