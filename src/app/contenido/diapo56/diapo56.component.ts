...
@Component({
  selector: 'app-diapo56',
  templateUrl: './diapo56.component.html',
  styleUrls: ['./diapo56.component.scss']
})

export class Diapo56Component implements OnInit {
    ...
    pregunta = {
        id: '43',
        question: 'Contractem un Regidor d’un Ajuntament  amb l’objectiu de tenir mes facilitats en l’adjudicació de concursos públics. ',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'La contractació d’un càrrec públic amb finalitat d’obtenir facilitat en l’adjudicació de concursos públics seria un delicte de suborn. '
        ]
    }
