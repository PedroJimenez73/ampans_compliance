...
export class Diapo8Component implements OnInit {
    ...
    pregunta = {
        id: '1',
        question: 'De qui és responsabilitat el bon funcionament del Compliance (una sola opció de resposta):',
        answers: [
            'Del patronat d’AMPANS',
            'De tot el personal d’AMPANS',
            'De la direcció d’AMPANS',
            'Del responsable del compliance',
            'De l’espai de reflexió ètica d’AMPANS',
            'Dels directors/es de centres i serveis',
            'Totes les opcions són correctes'
        ],
        corrects: ['g'],
        feedback: [
            'La responsabilitat del bon funcionament del Compliance és de: el Patronat, tot el personal, el responsable del compliance i l’espai de reflexió ètica.'
        ]
    }
