...
@Component({
  selector: 'app-diapo71',
  templateUrl: './diapo71.component.html',
  styleUrls: ['./diapo71.component.scss']
})

export class Diapo71Component implements OnInit {
    ...
    pregunta = {
        id: '57',
        question: 'Posar el termòstat a 22 ºC a l’hivern mentre ocupen l’espai i abaixar-lo a 18 quant marxem o a la nit.',
        answers: [
        ...
        corrects: ['b'],
        feedback: [
            'La conducta que es descriu es del tot correcte.'
        ]
    }
