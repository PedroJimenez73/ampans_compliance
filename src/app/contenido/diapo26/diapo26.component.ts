...
export class Diapo26Component implements OnInit {
    ...
    pregunta = {
        id: '17',
        question: 'Donar una bufetada a una persona amb discapacitat que contínuament està realitzat una conducta molt provocadora.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'Pot constituir un maltractament i un delicte penal.'
        ]
    }
