...
export class Diapo45Component implements OnInit {
    ...
    pregunta = {
        id: '34',
        question: 'Copiar 20 pagines d’un document extern per fer la introducció d’un manual d’us d’AMPANS.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'Amb la informació que planteja la qüestió podríem estar atemptant contra la propietat intel·lectual. Tindríem dons que demanar autorització.'
        ]
    }
