...
export class Diapo48Component implements OnInit {
    ...
    pregunta = {
        id: '37',
        question: 'Posar un link a la nostra pagina web que porta a la descarrega gratuïta d’un llibre sobre discapacitat que encara està en el mercat i es ven per 25 €.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'El llibre esta subjecte a drets d’autor i esta prohibida la seva reproducció. La conducta no es correcte.'
        ]
    }
