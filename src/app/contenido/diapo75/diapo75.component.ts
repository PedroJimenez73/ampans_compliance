...
@Component({
  selector: 'app-diapo75',
  templateUrl: './diapo75.component.html',
  styleUrls: ['./diapo75.component.scss']
})

export class Diapo75Component implements OnInit {
    ...
    pregunta = {
        id: '60',
        question: 'Una empresa diu que tots els seus  “PATÉS”  son ecològics si solament n’hi ha un que no ho es.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'És un delicte. Estem davant una publicitat enganyosa.'
        ]
    }
