...
@Component({
  selector: 'app-diapo78',
  templateUrl: './diapo78.component.html',
  styleUrls: ['./diapo78.component.scss']
})

export class Diapo78Component implements OnInit {
    ...
    pregunta = {
        id: '62',
        question: 'Facturar a l’administració la plaça residencial d’un usuari  que els caps de setmana sempre està casa.',
        answers: [
        ...
        corrects: ['b'],
        feedback: [
            'Les persones ateses en serveis residencial tenen  el dret i la llibertar de fer estades amb les seves famílies o amics. L’absència d’una persona durant el cap de setmana no impacta en la reducció dels costos d’un servei residencial (elèctric, calefacció,  infermers, personal, etc.). Solament en una baixa llarga i segura tindríem que comunicar la no utilització de la plaça a l’administració.  La conducta es correcta.'
        ]
    }
