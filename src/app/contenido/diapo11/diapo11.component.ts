...
export class Diapo11Component implements OnInit {
    ...
    pregunta = {
        id: '4',
        question: 'Quina és la millor manera de denunciar una situació que pugui ser un delicte penal o una vulneració de l’ètica d’AMPANS (una sola opció de resposta).',
        answers: [
            'Enviant un correu a canal denuncies@ampans.cat',
            'Comunicant-ho al meu responsable',
            'Comunicant-ho a la direcció d’AMPANS'
        ],
        corrects: ['a'],
        feedback: [
            'La millor manera es enviar un correu a denuncies@AMPANS.cat.'
        ]
    }
