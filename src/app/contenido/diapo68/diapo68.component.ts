...
@Component({
  selector: 'app-diapo68',
  templateUrl: './diapo68.component.html',
  styleUrls: ['./diapo68.component.scss']
})

export class Diapo68Component implements OnInit {
    ...
    pregunta = {
        id: '54',
        question: 'Es rebenta un dipòsit d’oli arribant aquest a la xarxa de clavegueram. El recollim,  prenen mesures perquè no torni a passar però no avisem a ningú.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'La comunicació dels besaments es prescriptiva.'
        ]
    }
