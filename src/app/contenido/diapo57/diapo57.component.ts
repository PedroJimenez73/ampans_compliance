...
@Component({
  selector: 'app-diapo57',
  templateUrl: './diapo57.component.html',
  styleUrls: ['./diapo57.component.scss']
})

export class Diapo57Component implements OnInit {
    ...
    pregunta = {
        id: '44',
        question: 'Regalem a tots els nostre cients comercials un obsequi per Nadal consistent en tres ampolles de vi d’AMPANS.',
        answers: [
        ...
        corrects: ['b'],
        feedback: [
            'Es una petita mostra d’agraïment unes dates on tradicionalment es fan obsequis. No hi ha cap problema.'
        ]
    }
