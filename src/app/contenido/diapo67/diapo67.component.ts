...
@Component({
  selector: 'app-diapo67',
  templateUrl: './diapo67.component.html',
  styleUrls: ['./diapo67.component.scss']
})

export class Diapo67Component implements OnInit {
    ...
    pregunta = {
        id: '53',
        question: 'En un servei de Jardineria es realitza tractament fitosanitari amb un producte molt tòxic a la via pública sense informar al client i als usuaris de la via pública.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'La no informació es un delicte.'
        ]
    }
