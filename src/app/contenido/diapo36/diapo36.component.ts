...
export class Diapo36Component implements OnInit {
    ...
    pregunta = {
        id: '26',
        question: 'Penjar en el meu instagram una fotografia molt maca de les colònies que he fet amb un grup d’usuaris al Pedraforca si algun d’ells està  incapacitat.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'Tindríem que tenir autorització dels tutors per tal de poder publicar-la.'
        ]
    }
