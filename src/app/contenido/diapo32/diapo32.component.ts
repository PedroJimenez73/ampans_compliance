...
export class Diapo32Component implements OnInit {
    ...
    pregunta = {
        id: '23',
        question: 'Aplicar una dutxa d’aigua freda a una persona  que està molt alterada.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'Una actuació d’aquest tipus podria considerar-se una forma de maltractament físic. Pot comportar un risc penal.'
        ]
    }
