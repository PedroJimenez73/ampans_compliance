...
@Component({
  selector: 'app-diapo63',
  templateUrl: './diapo63.component.html',
  styleUrls: ['./diapo63.component.scss']
})

export class Diapo63Component implements OnInit {
    ...
    pregunta = {
        id: '50',
        question: 'El responsable de compres selecciona  un proveïdor perquè li ofereix un grans descompte.',
        answers: [
        ...
        corrects: ['b'],
        feedback: [
            'En el comportament descrit no s’aprecia cap interès personal ni practica punible. La conducta es correcte. '
        ]
    }
