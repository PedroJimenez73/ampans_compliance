...
@Component({
  selector: 'app-diapo29',
  templateUrl: './diapo29.component.html',
  styleUrls: ['./diapo29.component.scss']
})

export class Diapo29Component implements OnInit {
    ...
    pregunta = {
        id: '20',
        question: 'Administrar un ansiolític a una persona que està molt nerviosa que en el passat li havia anat molt be. ',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'L’administració de medicació sense prescripció medica pot constituir un delicte.'
        ]
    }
