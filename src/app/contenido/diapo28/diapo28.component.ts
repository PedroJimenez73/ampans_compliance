...
@Component({
  selector: 'app-diapo28',
  templateUrl: './diapo28.component.html',
  styleUrls: ['./diapo28.component.scss']
})

export class Diapo28Component implements OnInit {
    ...
    pregunta = {
        id: '19',
        question: 'Definir unes pautes de tractament de les conductes problemes d’una persona  on en cas de mal comportament es prohibeix la visita dels familiars al centre sense consultar als pares / tutors.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'La privació del contacte amb les persones amb lligams emocionals ens te generar un dubte ètic i s’ha d’abordar aquesta practica amb una reflexió amplia.'
        ]
    }
