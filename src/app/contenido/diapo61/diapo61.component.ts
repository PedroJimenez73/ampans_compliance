...
export class Diapo61Component implements OnInit {
    ...
    pregunta = {
        id: '48',
        question: 'El responsable de compres selecciona  un proveïdor perquè és del poble on hi ha el servei.',
        answers: [
        ...
        corrects: ['b'],
        feedback: [
            'No s’aprecia cap tracte de favor ni interès personal ni cap a un tercer. El criteri de selecció es el foment de l’economia local. La conducta es adequada.'
        ]
    }
