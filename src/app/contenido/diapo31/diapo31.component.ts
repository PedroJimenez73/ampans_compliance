...
export class Diapo31Component implements OnInit {
    ...
    pregunta = {
        id: '22',
        question: 'Definir unes pautes de tractament de les conductes problemes d’una persona  on en cas de mal comportament en qualsevol  moment del dia se li retira el sopar.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'El càstig negatiu que mostra la pregunta la pregunta pot implicar una limitació  en el cobriment de les necessitats bàsiques. Sempre caldria consensuar-ho amb AMPANS.'
        ]
    }
