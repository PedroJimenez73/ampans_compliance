...
@Component({
  selector: 'app-diapo27',
  templateUrl: './diapo27.component.html',
  styleUrls: ['./diapo27.component.scss']
})

export class Diapo27Component implements OnInit {
    ...
    pregunta = {
        id: '18',
        question: 'Deixar a una persona sola en un servei  durant tota l’estona que dura una sortida a Barcelona perquè s’ha portant molt malament.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'Pot ser interpretat com una forma d’abandonament. Comporta risc penal.'
        ]
    }
