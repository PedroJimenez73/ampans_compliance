...
@Component({
  selector: 'app-diapo37',
  templateUrl: './diapo37.component.html',
  styleUrls: ['./diapo37.component.scss']
})

export class Diapo37Component implements OnInit {
    ...
    pregunta = {
        id: '27',
        question: 'Supervisar les xarxes socials obertes d’un usuari.',
        answers: [
        ...
        corrects: ['b'],
        feedback: [
            'Les xarxes obertes son obertes per a tothom. No suposa cap delicte ni conducte ètica qüestionable. Es voluntat de les persones deixar-les obertes o restringir-les.'
        ]
    }
