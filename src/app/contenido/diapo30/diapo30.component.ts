...
@Component({
  selector: 'app-diapo30',
  templateUrl: './diapo30.component.html',
  styleUrls: ['./diapo30.component.scss']
})

export class Diapo30Component implements OnInit {
    ...
    pregunta = {
        id: '21',
        question: 'No comunicar que un companys de feina va donar una bufetada a un usuari en un episodi d’alteració de comportament.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'L’ocultació d’un possible maltractament es un delicte.'
        ]
    }
