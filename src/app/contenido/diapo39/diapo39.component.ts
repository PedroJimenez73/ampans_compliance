...
export class Diapo39Component implements OnInit {
    ...
    pregunta = {
        id: '29',
        question: 'Instal·lar càmeres en l’habitació d’una persona gran epilèptica per fer-ne un seguiment per la nit.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'La gravació d’imatges en un espai privat com es una habitació malgrat sigui per una fi adequada no es pot realitzar dons vulnera el dret a la intimitat. Caldria dons cercar estratègies com autoritzacions, estudis en situació de laboratori  d’uns dies determinats, etc.'
        ]
    }
