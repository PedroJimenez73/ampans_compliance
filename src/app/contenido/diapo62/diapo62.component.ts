...
@Component({
  selector: 'app-diapo62',
  templateUrl: './diapo62.component.html',
  styleUrls: ['./diapo62.component.scss']
})

export class Diapo62Component implements OnInit {
    ...
    pregunta = {
        id: '49',
        question: 'El responsable de compres selecciona  un proveïdor perquè li ofereix uns regals al acabar l’any.',
        answers: [
        ...
        corrects: ['a'],
        feedback: [
            'En la conducta del responsable de compres hi ha un clar interès en el benefici propi. La conducta no es adequada.'
        ]
    }
