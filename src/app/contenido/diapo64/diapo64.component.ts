...
@Component({
  selector: 'app-diapo64',
  templateUrl: './diapo64.component.html',
  styleUrls: ['./diapo64.component.scss']
})

export class Diapo64Component implements OnInit {
    ...
    pregunta = {
        ...
        corrects: ['a'],
        feedback: [
            'Estaríem davant un delicte de frau fiscal.'
        ]
    }
