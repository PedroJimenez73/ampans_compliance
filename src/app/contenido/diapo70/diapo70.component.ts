...
@Component({
  selector: 'app-diapo70',
  templateUrl: './diapo70.component.html',
  styleUrls: ['./diapo70.component.scss']
})

export class Diapo70Component implements OnInit {
    ...
    pregunta = {
        id: '56',
        question: 'Treure un rusc d’abelles que està molt a prop del pati dels usuaris.',
        answers: [
        ...
        corrects: ['b'],
        feedback: [
            'Si el rusc d’abelles el treu una persona autoritzada no hi ha cap problema. No fer-ho seria una exposar a un risc als alumnes.'
        ]
    }
